...
// function change(){
        ...
        echo color("green","\n▬▬▬▬▬▬▬▬▬▬▬▬🎫AUTO REDEEM TOD🎫▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("white","🔐▶️ Claim Voucher EatLah 1OK");
	...
	gocar:
        echo "\n".color("white","🔐▶️ Claim VOUCHER GOFOOD Bandung 20K 10K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        ...
        echo "\n".color("green","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","🔐▶️ Claim voc GOFOOD Jakarta 15K 10K 5K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(3);
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
        echo "\n".color("white","🔐▶️ Claim voc GoFood Surabaya 20K 10K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(1);
	...
	$post = [
         ...
         echo color("green","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN MU =  010101 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"010101"}';
