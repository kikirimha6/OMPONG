...
echo color("white","                  Format Kode 62*** \n");
	...
	gocar:
        ...
        sleep(3);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GFBARUMALANG"}');
	...
	$post = [
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MU = 114111 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"114111"}';
